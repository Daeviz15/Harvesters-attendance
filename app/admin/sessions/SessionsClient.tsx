                ...
                {checkInModalSession && (
                    <>
                        ...
                        <motion.div
                            ...
                            animate={{ opacity: 1, scale: 1, y: 0 }}
                            exit={{ opacity: 0, scale: 0.95, y: 20 }}
                            className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[calc(100vw-1.5rem)] sm:w-full max-w-xl bg-white dark:bg-[#0f0f0f] border border-neutral-200 dark:border-white/10 rounded-2xl shadow-2xl z-50 overflow-hidden max-h-[90vh] flex flex-col"
                        >
                            {/* Modal Header */}
                            <div className="p-4 sm:p-5 border-b border-neutral-100 dark:border-white/5 flex items-center justify-between shrink-0">
                                <div>
                            ...
                            <div className="p-4 sm:p-5 overflow-y-auto space-y-4 flex-1">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        type="text"
                                        placeholder="Search by name, department, worker ID..."
                                        value={searchQuery}
                                    ...
                                    {searchResults.length === 0 ? (
                                        ...
                                        <div className="space-y-2 max-h-60 overflow-y-auto pr-1">
                                            {searchResults.map((worker) => (
                                                <div
                                                    key={worker.id}
                                                    className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-3 p-3 rounded-xl bg-neutral-50 dark:bg-white/5 border border-neutral-100 dark:border-white/5"
                                                >
                                                    ...
                                                    {worker.isCheckedIn ? (
                                                        <span className="flex items-center justify-center sm:justify-start gap-1 text-xs font-bold text-[#34A853] bg-[#34A853]/10 px-3 py-1.5 rounded-lg shrink-0">
