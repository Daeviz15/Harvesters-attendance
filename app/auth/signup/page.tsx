        ...
        <main className="min-h-screen w-full flex items-center justify-center bg-background text-foreground relative overflow-hidden font-sans transition-colors duration-300">
            ...
            >
                ...
                <div className="mb-12 flex flex-col items-start relative">
                    ...
                    <h1 className="text-[22px] font-semibold tracking-wide text-neutral-800 dark:text-white/90 -mt-10 ml-12 relative z-20">Sign up to Continue</h1>
                </div>
                ...
                <form action={formAction} className="space-y-8 flex-1">
                    ...
                    <div className="flex items-start gap-3 mt-8">
                        <input
                            ...
                            id="terms"
                            required
                            className="mt-1 w-4 h-4 rounded border-neutral-300 dark:border-white/20 bg-neutral-200/50 dark:bg-white/5 focus:ring-[#34A853] focus:ring-offset-background appearance-none checked:bg-[#34A853] checked:border-[#34A853] relative
