        ...
        <main className="min-h-screen w-full flex items-center justify-center bg-[#0a0a0a] text-[#ededed] relative overflow-hidden font-sans">
            ...
            >
                ...
                <div className="mb-12 flex flex-col items-start relative">
                    ...
                    <h1 className="text-[22px] font-semibold tracking-wide text-white/90 -mt-10 ml-12 relative z-20">Login to Continue</h1>
                </div>

                {/* Google OAuth */}
                <div className="mb-10 w-full">
                    <button className="w-full flex items-center justify-center gap-3 py-3.5 bg-white/5 hover:bg-white/10 border border-white/10 rounded-full transition-colors cursor-none">
                ...
                <form action={formAction} className="space-y-8 flex-1">
                    ...
                    <div className="flex items-center justify-between mt-8">
                        <div className="flex items-start gap-3">
                            ...
                            />
                            <label htmlFor="remember" className="text-[13px] text-white/60 leading-tight cursor-none select-none">
                                Remember me
                            </label>
                        </div>
                ...
                <div className="mt-10 text-center">
                    <p className="text-[13px] text-white/50">
                        ...
                        <Link href="/auth/signup" className="text-[#34A853] font-semibold hover:underline cursor-none">
                            Sign Up
                        </Link>
                    </p>
                </div>
