        ...
        <main className="min-h-screen w-full flex items-center justify-center bg-background text-foreground relative overflow-hidden font-sans transition-colors duration-300">
            ...
            >
                ...
                <div className="mb-10 w-full">
                    <button className="w-full flex items-center justify-center gap-3 py-3.5 bg-neutral-200/50 hover:bg-neutral-200/80 dark:bg-white/5 dark:hover:bg-white/10 border border-neutral-300 dark:border-white/10 rounded-full transition-colors">
                        ...
                        <span className="text-sm font-medium tracking-wide text-neutral-700 dark:text-white/80">Continue with Google?</span>
                    </button>
                </div>
