        ...
        <main className="min-h-screen w-full flex items-center justify-center bg-background text-foreground relative overflow-hidden font-sans transition-colors duration-300">
            ...
            >
                ...
                <div className="mb-12 flex flex-col items-start relative">
                    ...
                    <h1 className="text-[22px] font-semibold tracking-wide text-neutral-800 dark:text-white/90 -mt-10 ml-12 relative z-20">Login to Continue</h1>
                </div>
                ...
                <div className="mb-10 w-full">
                    <button
                        ...
                        type="button"
                        className="w-full flex items-center justify-center gap-3 py-3.5 bg-neutral-200/50 hover:bg-neutral-200/80 dark:bg-white/5 dark:hover:bg-white/10 border border-neutral-300 dark:border-white/10 rounded-full transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
                    >
                        {isGoogleLoading ? (
                        ...
                        <span className="text-sm font-medium tracking-wide text-neutral-700 dark:text-white/80">
                ...
                <form action={formAction} className="space-y-8 flex-1">
                    ...
                    {/* Password */}
                    <div className="relative group">
                        <label className="text-[11px] font-medium uppercase tracking-wider text-neutral-500 dark:text-white/50 block mb-2">Password</label>
                        <div className="flex items-center border-b border-neutral-300 dark:border-white/10 group-focus-within:border-neutral-500 dark:group-focus-within:border-white/40 transition-colors pb-2">
                            <input
                                type="password"
                                name="password"
                                ...
                                placeholder="••••••••"
                            />
                            <Lock className="w-5 h-5 text-neutral-400 dark:text-white/30 ml-3" />
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between mt-8">
                        <div className="flex items-start gap-3">
                            <input
                                type="checkbox"
                                id="remember"
                                className="mt-0.5 w-4 h-4 rounded border-neutral-300 dark:border-white/20 bg-neutral-200/50 dark:bg-white/5 focus:ring-[#34A853] focus:ring-offset-background appearance-none checked:bg-[#34A853] checked:border-[#34A853] relative
                                before:content-[''] before:absolute before:inset-0 before:bg-[url('data:image/svg+xml;base64,')] before:bg-center before:bg-no-repeat before:bg-[length:12px_12px] before:opacity-0 checked:before:opacity-100 transition-all"
                            />
                            <label htmlFor="remember" className="text-[13px] text-neutral-600 dark:text-white/60 leading-tight select-none">
                                Remember me
                            </label>
                        </div>
                    ...
                    <button
                        type="submit"
                        disabled={isPending}
                        className="w-full mt-6 bg-[#34A853] hover:bg-[#2e9347] text-white py-4 rounded-xl font-semibold tracking-wider text-[13px] uppercase transition-colors disabled:opacity-70"
                    >
                        Login
                    </button>
                </form>
