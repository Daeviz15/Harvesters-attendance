                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-1.5">
                      <div className="flex items-center justify-between">
                        ...
                        <Link href="#" className="text-xs font-medium text-slate-900 hover:underline">
                          Forgot password?
                        </Link>
                      </div>
                      <FormControl>
      ...
      <div className="relative hidden lg:block">
        ...
        <div className="absolute bottom-12 left-12 right-12 text-white">
          <blockquote className="font-serif text-2xl leading-snug">
            "Harvesters Church Management System gave our workers team back their Sunday mornings."
          </blockquote>
          <div className="mt-4 text-sm text-white/80">
            Pastor Sarah — Lekki Campus
          </div>
        </div>
      </div>
    </div>
