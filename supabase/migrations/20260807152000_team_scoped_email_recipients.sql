-- Ensure Team Admin team-wide events only enqueue email recipients from that team.
-- This replaces the scheduler function with the same stale-follow-up protections
-- plus explicit event scope matching for department, team, and global events.
...
BEGIN
    ...
    JOIN public.profiles profile_row
        ...
        AND (
            (event_row.department_id IS NOT NULL AND profile_row.department_id = event_row.department_id)
            OR (
