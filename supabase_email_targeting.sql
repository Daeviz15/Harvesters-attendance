-- Migration: Add targeted workers for email notifications
...
COMMENT ON COLUMN public.events.email_target_worker_ids IS 'If null or empty, emails go to all eligible workers. If populated, emails only go to the specified worker IDs.';
